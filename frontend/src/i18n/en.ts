export const en = {
  ...
  'processing.analyzing_entities': 'Analyzing entities…',
  'processing.detecting_hate_speech': 'Detecting hate speech…',
  'processing.diarizing': 'Detecting speakers…',
  ...
  'artifacts.download_archive': 'Download all',

  // errors
  'errors.upload_failed': 'Upload failed: {error}',
